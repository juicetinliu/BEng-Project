...
void setup(){
  ...
  randomSeed(16);
  pucks.add(new Puck(1, random(width),random(height),50));
  pucks.add(new Puck(2, random(width),random(height),50));
  pucks.add(new Puck(3, random(width),random(height),50));
  pucks.add(new Puck(4, random(width),random(height),50));
